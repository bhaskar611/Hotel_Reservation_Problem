...
public class HotelReservation {
	...
	public String CheapestByRating(String dateOfArrival, String dateOfDeparture) {
		...
		System.out.println(
				"Cost for " + hotelName + " is " + cost + " and rating is " + rating);
		return hotelName;
	}
	...
	public ArrayList<String> CheapestHotel(String dateOfArrival, String dateOfDeparture) {
		...
		if (minCostHotel == minCostRidgeWood)
			hotel.add("RidgeWood");
		System.out.println("Minimum cost for Hotel is " + minCostHotel);
		return hotel;
	}

	// UC6 Find cheapest hotel with maximum rating 

	public String CheapestCostMaxRatings(String dateOfArrival, String dateOfDeparture) {
		int rating = 0;
		LocalDate dateArrival = LocalDate.parse(dateOfArrival);
		LocalDate dateDeparture = LocalDate.parse(dateOfDeparture);
		totalDays = ChronoUnit.DAYS.between(dateArrival, dateDeparture) + 1;
		...
		System.out.println("Cost for " + hotelName + " is " + minCostHotel
